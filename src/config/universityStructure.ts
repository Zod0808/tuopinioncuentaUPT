export const FACULTADES: Record<string, { nombre: string; carreras: string[] }> = {
  ...
  FAEDCOH: {
    ...
    carreras: [
      ...
      'Carrera de Educación Fisica y Deportes',
...
export const ESCALA_CALIFICACION: Record<Calificacion, { min: number; max: number; color: string; interpretacion: string }> = {
  DESTACADO:       { min: 17.01, max: 20,    color: '#276749', interpretacion: 'El docente tiene muy buen desempeño en el aula, se le felicita' },
  BUENO:           { min: 14.01, max: 17.00, color: '#2b6cb0', interpretacion: 'El docente tiene un desempeño correcto, pero debe seguir mejorando para optimizar sus resultados' },
  ACEPTABLE:       { min: 11.01, max: 14.00, color: '#c05621', interpretacion: 'Si bien el desempeño de docente en aula es aceptable, debe replantear su desempeño en los aspectos que marcan falencias' },
  INSATISFACTORIO: { min: 0,     max: 11.00, color: '#c53030', interpretacion: 'El docente debe reprogramar en gran medida su desempeño en aula' },
};
