...
export const ESCALA_CALIFICACION: Record<Calificacion, { min: number; max: number; color: string; interpretacion: string }> = {
  ...
  BUENO:           { min: 15, max: 17, color: '#ED7D31', interpretacion: 'El docente tiene un desempeño correcto, pero debe seguir mejorando para optimizar sus resultados' },
  ACEPTABLE:       { min: 12, max: 14, color: '#A5A5A5', interpretacion: 'Si bien el desempeño del docente en aula es aceptable, debe replantear su desempeño en los aspectos que marcan falencias' },
  INSATISFACTORIO: { min: 0,  max: 11, color: '#FFC000', interpretacion: 'El docente debe reprogramar en gran medida su desempeño en aula' },
};
